    ...
    class ractangle
    {
        ...
        public static OpenCvSharp.Point[] Square(Mat src)
        {
            ...
            for (int channel = 0; channel < 3; channel++)
            {
                ...
                for (int i = 0; i < N; i++)
                {
                    Cv2.Threshold(blur, binary, 140, 255, ThresholdTypes.Binary);
        ...
        public static string OCR(Mat src)
        {
            ...
            TesseractEngine ocr = new TesseractEngine(@"C:\Users\lms\Desktop\BillProject\BillProject\tessdata\", "eng", EngineMode.LstmOnly);
